...
class Frame(wx.Frame):
    ...
    def __init__(self, parent, id, title):
        ...
        # panel1 for the tree representation part and panel2 for displaying the
        # node characteristics when activated on the tree
        self.panel1 = wx.Panel(self, -1)
        self.panel2 = wx.Panel(self, -1)

        self.tree = wx.TreeCtrl(
                               self.panel1, 1, wx.DefaultPosition,
        ...
        self.StaticText_Node_Type_List = wx.StaticText(
            self.panel2, -1, "Node Type :")
        h1box.Add(self.StaticText_Node_Type_List, 1)
        self.StaticText_Node_Type_List1 = wx.StaticText(
            self.panel2, -1, label='_')
        h1box.Add(self.StaticText_Node_Type_List1, 1)

        vbox2.Add(h1box, 1, wx.EXPAND)

        h7box = wx.BoxSizer(wx.HORIZONTAL)
        self.StaticText_Node_Parent = wx.StaticText(
            self.panel2, -1, "Node Parent :")
        h7box.Add(self.StaticText_Node_Parent, 1)
        self.StaticText_Node_Parent1 = wx.StaticText(
            self.panel2, -1, label='_')
        ...
        self.StaticText_Node_Name = wx.StaticText(
            self.panel2, -1, "Node Name :")
        ...
        self.StaticText_Node_Function = wx.StaticText(
            self.panel2, -1, 'Node Function:')
        h8box.Add(self.StaticText_Node_Function, 1)
        self.StaticText_Node_Function1 = wx.StaticText(
            self.panel2, -1, label='_')
        ...
        self.StaticText_Start_C = wx.StaticText(
            self.panel2, -1, "Start Condition:")
        ...
        self.StaticText_Pre_C = wx.StaticText(
            self.panel2, -1, "Pre Condition:")
        ...
        self.StaticText_Repeat_C = wx.StaticText(
            self.panel2, -1, "Repeat Condition :")
        ...
        self.StaticText_End_C = wx.StaticText(
            self.panel2, -1, "End Condition :")
        ...
        self.StaticText_Inv_C = wx.StaticText(
            self.panel2, -1, "Invarient Condition :")
        ...
        self.StaticText_Exit_C = wx.StaticText(
            self.panel2, -1, "Exit Condition :")
        ...
        self.StaticText_Post_C = wx.StaticText(
            self.panel2, -1, "Post Condition :")
        ...
        self.StaticText_Skip_C = wx.StaticText(
            self.panel2, -1, "Skip Condition :")
    ...
    def OnClicked(self, e):
        ...
        self.StaticBox1 = wx.StaticBox(
            panel, -1, 'Node Specifications :', size=(650, 100))
        self.Static_BoxSizer1 = wx.StaticBoxSizer(self.StaticBox1, wx.VERTICAL)

        # Definitions of the text widgets in Node Specification
        self.StaticText_Node_Type_List = wx.StaticText(
            panel, -1, "Node Type :")
        self.Node_Type_List = wx.ComboBox(
            panel, -1, size=(200, -1), choices=self.List, style=wx.CB_READONLY)
        ...
        self.StaticText_Node_Function = wx.StaticText(
            panel, -1, 'Node Function:')
        self.Node_Function = wx.TextCtrl(
            panel, size=(200, 50), style=wx.TE_MULTILINE)
...
# Node Condition Part##################################
        ...
        self.Static_Box2 = wx.StaticBox(
            panel, -1, 'Node Conditions :', size=(650, 100))
        self.Static_BoxSizer2 = wx.StaticBoxSizer(
            self.Static_Box2, wx.VERTICAL)
        ...
        self.StaticText_Repeat_C = wx.StaticText(
            panel, -1, "Repeat Condition :")
        ht5box.Add(self.StaticText_Repeat_C, 1)

        self.Text_Repeat_C = wx.TextCtrl(
            panel, size=(200, 50), style=wx.TE_MULTILINE)
        ...
        self.StaticText_Inv_C = wx.StaticText(
            panel, -1, "Invarient Condition :")
        ht7box.Add(self.StaticText_Inv_C, 1)

        self.Text_Inv_C = wx.TextCtrl(
            panel, size=(200, 50), style=wx.TE_MULTILINE)
    ...
    def On_Clicked(self, e):
        ...
        '''
        if Node_Type == 'List':
            self.a[str(Node_Name)] = self.tree.AppendItem(
                self.a[Node_Parent], Node_Type + ':' + str(Node_Name))

        else:
            self.tree.AppendItem(
                self.a[Node_Parent],
                Node_Type + ':' + str(Node_Name))
