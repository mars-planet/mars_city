...
class Plan(object):
    ...
    def __init__(self, europa_log):
        ...
        # Process raw time constraints from PLASMA database
        ...
        # Extract the Planned Actions to take place along with time constraints
        actions_log = re.findall(r'Tokens(.*?)End Tokens', europa_log,
                                 re.DOTALL)
        for action in actions_log:
            ...
            if match:
                ...
                # Constraints are repsented as a Temporal Network
                start = True
                event_info = []
                last_lower = ""
