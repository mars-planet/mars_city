...
2. Setup pyOVR
	...
	If you modify it, remember that the path can't be relative! It has to be the full path to the library.
	...
	If successful, you should see the output of the Quaternion values, Rift's FusionSensor provides.
