...
class Finger(Pointable):
    ...
    if _newclass:type = _swig_property(LeapPython.Finger_type_get)
...
class Device(Interface):
    ...
    if _newclass:baseline = _swig_property(LeapPython.Device_baseline_get)
...
class Image(Interface):
    ...
    if _newclass:timestamp = _swig_property(LeapPython.Image_timestamp_get)
    ...
    if _newclass:data_pointer = _swig_property(LeapPython.Image_data_pointer_get)
    __swig_getmethods__["distortion_pointer"] = LeapPython.Image_distortion_pointer_get
    if _newclass:distortion_pointer = _swig_property(LeapPython.Image_distortion_pointer_get)
...
class Mask(Interface):
    ...
    if _newclass:invalid = staticmethod(LeapPython.Mask_invalid)
    ...
    if _newclass:sequence_id = _swig_property(LeapPython.Mask_sequence_id_get)
    __swig_getmethods__["id"] = LeapPython.Mask_id_get
    if _newclass:id = _swig_property(LeapPython.Mask_id_get)
    __swig_getmethods__["width"] = LeapPython.Mask_width_get
    if _newclass:width = _swig_property(LeapPython.Mask_width_get)
    __swig_getmethods__["height"] = LeapPython.Mask_height_get
    if _newclass:height = _swig_property(LeapPython.Mask_height_get)
    __swig_getmethods__["offset_x"] = LeapPython.Mask_offset_x_get
    if _newclass:offset_x = _swig_property(LeapPython.Mask_offset_x_get)
    __swig_getmethods__["offset_y"] = LeapPython.Mask_offset_y_get
    if _newclass:offset_y = _swig_property(LeapPython.Mask_offset_y_get)
    __swig_getmethods__["is_valid"] = LeapPython.Mask_is_valid_get
    if _newclass:is_valid = _swig_property(LeapPython.Mask_is_valid_get)
    def data(self):
    ...
    if _newclass:data_pointer = _swig_property(LeapPython.Mask_data_pointer_get)
...
class TrackedQuad(Interface):
    ...
    if _newclass:width = _swig_property(LeapPython.TrackedQuad_width_get)
    __swig_getmethods__["height"] = LeapPython.TrackedQuad_height_get
    if _newclass:height = _swig_property(LeapPython.TrackedQuad_height_get)
    __swig_getmethods__["resolution_x"] = LeapPython.TrackedQuad_resolution_x_get
    if _newclass:resolution_x = _swig_property(LeapPython.TrackedQuad_resolution_x_get)
    __swig_getmethods__["resolution_y"] = LeapPython.TrackedQuad_resolution_y_get
    if _newclass:resolution_y = _swig_property(LeapPython.TrackedQuad_resolution_y_get)
    __swig_getmethods__["visible"] = LeapPython.TrackedQuad_visible_get
    if _newclass:visible = _swig_property(LeapPython.TrackedQuad_visible_get)
    __swig_getmethods__["orientation"] = LeapPython.TrackedQuad_orientation_get
    if _newclass:orientation = _swig_property(LeapPython.TrackedQuad_orientation_get)
    __swig_getmethods__["position"] = LeapPython.TrackedQuad_position_get
    if _newclass:position = _swig_property(LeapPython.TrackedQuad_position_get)
    __swig_getmethods__["masks"] = LeapPython.TrackedQuad_masks_get
    if _newclass:masks = _swig_property(LeapPython.TrackedQuad_masks_get)
    __swig_getmethods__["images"] = LeapPython.TrackedQuad_images_get
    if _newclass:images = _swig_property(LeapPython.TrackedQuad_images_get)
    __swig_getmethods__["is_valid"] = LeapPython.TrackedQuad_is_valid_get
    if _newclass:is_valid = _swig_property(LeapPython.TrackedQuad_is_valid_get)
...
class MaskList(Interface):
    ...
    def __getitem__(self, *args): return LeapPython.MaskList___getitem__(self, *args)
    ...
    if _newclass:is_empty = _swig_property(LeapPython.MaskList_is_empty_get)
    def __iter__(self):
      _pos = 0
      while _pos < len(self):
        yield self[_pos]
...
class Frame(Interface):
    ...
    if _newclass:tracked_quad = _swig_property(LeapPython.Frame_tracked_quad_get)
    def serialize(self):
...
class BugReport(Interface):
    ...
    def begin_recording(self): return LeapPython.BugReport_begin_recording(self)
    ...
    if _newclass:is_active = _swig_property(LeapPython.BugReport_is_active_get)
    __swig_getmethods__["progress"] = LeapPython.BugReport_progress_get
    if _newclass:progress = _swig_property(LeapPython.BugReport_progress_get)
    __swig_getmethods__["duration"] = LeapPython.BugReport_duration_get
    if _newclass:duration = _swig_property(LeapPython.BugReport_duration_get)
...
class Controller(Interface):
    ...
    if _newclass:tracked_quad = _swig_property(LeapPython.Controller_tracked_quad_get)
    __swig_getmethods__["bug_report"] = LeapPython.Controller_bug_report_get
    if _newclass:bug_report = _swig_property(LeapPython.Controller_bug_report_get)
